...
logistic_model1.fit(X_train_resampled, y_train_resampled)

# Make predictions on the original test set
y_pred_original = logistic_model1.predict(X_test_original)
...
y_pred_resampled = logistic_model1.predict(X_train_resampled)
...
# Adjust the threshold (example: 0.)
adjusted_predictions = (proba > 0.2).astype(int)
...
pickle.dump(logistic_model1, open('/content/logistic_model1','wb'))

model_loaded=pickle.load(open('/content/logistic_model1','rb'))
