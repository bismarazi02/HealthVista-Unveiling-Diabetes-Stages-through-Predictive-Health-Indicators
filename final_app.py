...
sns.scatterplot(x='Age_Midpoint', y='HighBP', data=df, hue='Diabetes_binary', palette='Greens', ax=ax1)
...
ax3 = sns.scatterplot(x='Age_Midpoint', y='HighChol', data=df, hue='Diabetes_binary', palette='magma')
...
ax8 = sns.scatterplot(x=user_data['Age_Midpoint'], y=user_data['BMI'], s=150, color=color)
plt.xticks(np.arange(10, 100, 5))
...
ax10 = sns.scatterplot(x=user_data['Age_Midpoint'], y=user_data['Smoker'], s=150, color=color)
plt.xticks(np.arange(10, 100, 5))
plt.yticks(np.arange(0, 2, 1))
plt.title('0 - Healthy & 1 - Unhealthy')
